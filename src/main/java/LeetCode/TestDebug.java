...
public class TestDebug {
    ...
    public static int myAtoi(String str) {
        ...
        for( ;i < str1.length() ; i++) {
            ...
            if(c1 > 47 && c1 < 58) {
                int num = c1-48;
                if(index != 1 && (result > Integer.MAX_VALUE/10 || (result == Integer.MAX_VALUE/10 && num >= 7))) return Integer.MAX_VALUE;
                if(index == 1 && (result > Integer.MAX_VALUE/10 || (result == Integer.MAX_VALUE/10 && num >= 8))) return Integer.MIN_VALUE;
    ...
    public static void main(String[] args) {
        ...
        StringBuilder result = new StringBuilder("wwwrt");
